...
class Book(db.Model):
    ...
    book_id = db.Column(db.BigInteger, primary_key=True, unique=True)
...
class Borrow(db.Model):
    ...
    borrow_id = db.Column(db.BigInteger, primary_key=True, unique=True)
...
class Log(db.Model):
    ...
    log_id = db.Column(db.BigInteger, primary_key=True, unique=True)
...
class Notification(db.Model):
    ...
    notification_id = db.Column(db.BigInteger, primary_key=True, unique=True)
    user_id = db.Column(db.Integer)
...
class Reservation(db.Model):
    ...
    reservation_id = db.Column(db.BigInteger, primary_key=True, unique=True)
    user_id = db.Column(db.Integer)
...
class Sample(db.Model):
    ...
    sample_id = db.Column(db.BigInteger, primary_key=True, unique=True)
    book_id = db.Column(db.Integer)
