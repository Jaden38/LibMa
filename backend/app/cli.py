...
def db_status():
    ...
    try:
        with app.app_context():
            ...
            from app.models import Livre, Utilisateur, Exemplaire, Emprunt, Reservation, Notification, Log
...
def reset_db():
    ...
    if click.confirm('Are you sure you want to reset the database? This will delete all data!', default=False):
        try:
            with app.app_context():
                db.drop_all()
                db.create_all()
